...
-(void)animationDidStart:(CAAnimation *)anim{
    ...
    [UIView animateWithDuration:duration delay:delay options:UIViewAnimationOptionCurveEaseOut| UIViewAnimationOptionBeginFromCurrentState animations:^{
        weakSelf.ball1.transform = CGAffineTransformMakeScale(ballScale, ballScale);
        weakSelf.ball2.transform = CGAffineTransformMakeScale(ballScale, ballScale);
        weakSelf.ball3.transform = CGAffineTransformMakeScale(ballScale, ballScale);
        ...
        [UIView animateWithDuration:duration delay:delay options:UIViewAnimationOptionCurveEaseInOut| UIViewAnimationOptionBeginFromCurrentState animations:^{
            weakSelf.ball1.transform = CGAffineTransformIdentity;
            weakSelf.ball2.transform = CGAffineTransformIdentity;
            weakSelf.ball3.transform = CGAffineTransformIdentity;
        } completion:nil];
    }];
}
