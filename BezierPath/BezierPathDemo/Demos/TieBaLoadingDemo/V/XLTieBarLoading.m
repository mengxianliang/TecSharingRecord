...
{
    //画了个圆
    _container = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 50*TestScale, 50*TestScale)];
...
{
    //振幅
    _waveAmplitude = 3*TestScale;
    //角速度
    _wavePalstance = 0.12/TestScale;
    //偏距
